-- hyprland/themes/silver-wolf.lua
-- Aesthetic Silver Wolf theme (Neon Violet & Cyber Cyan on Deep Void).
...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border   = { colors = { "rgba(a855f7ff)", "rgba(00f0ffff)" }, angle = 45 },
            inactive_border = "rgba(1b1536aa)",
        },
