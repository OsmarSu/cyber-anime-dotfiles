-- hyprland/themes/blue-archive.lua
-- Aesthetic Blue Archive theme (Kivotos Sky Azure & Halo Gold on Oceanic Navy).
...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border   = { colors = { "rgba(38bdf8ff)", "rgba(ffd166ff)" }, angle = 45 },
            inactive_border = "rgba(142944aa)",
        },
