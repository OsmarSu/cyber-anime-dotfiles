-- hyprland/themes/crimson-rose.lua
-- Aesthetic Crimson Rose theme (Camellya / Kurumi / Zero Two Crimson on Velvet Obsidian).
...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border   = { colors = { "rgba(ff0055ff)", "rgba(ff758fff)" }, angle = 45 },
            inactive_border = "rgba(24101baa)",
        },
