-- hyprland/themes/furina-hydro.lua
-- Aesthetic Furina Hydro theme (Fontaine Blue & Opera Gold on Abyssal Indigo).
...
hl.config({
    general = {
        ...
        border_size = 2,
        col = {
            active_border   = { colors = { "rgba(00c2cbff)", "rgba(ffd166ff)" }, angle = 45 },
            inactive_border = "rgba(142440aa)",
        },
